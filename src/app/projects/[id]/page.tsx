  ...
  courses: [
    {
      ...
      description:
        "MERN stack e-commerce website with features like filtering products, cart, authentication and payment gateway.",
      image: [
        "/courses/e1.png",
        "/courses/e9.png",
        "/courses/e2.png",
    ...
    },
    {
      ...
      description:
        "Full Stack social media website using React js and Appwrite where people can share, create, delete and update posts.",
      image: [
        "/courses/landing.png",
        "/courses/signin.png",
        "/courses/steve.png",
...
const Page = ({ params }: { params: { id: string } }) => {
  const project = courseData.courses.find((item) => item.id.toString() === params.id);
