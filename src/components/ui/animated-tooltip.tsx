        ...
        >
         ...
         <Link href={item.go}>
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="object-cover !m-0 !p-0 object-top rounded-full h-14 w-14 border-2 group-hover:scale-105 group-hover:z-30 bg-white  relative transition duration-500"
          />
          </Link>
        </div>
      ))}
